...
execute_process(
  COMMAND "/usr/bin/git" show-ref "netanim-3.108"
  WORKING_DIRECTORY "/home/ns3/ns-allinone-3.36.1/ns-3.36.1/build/_deps/netanim-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "netanim-3.108")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("netanim-3.108" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/netanim-3.108")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ns3/ns-allinone-3.36.1/ns-3.36.1/build/_deps/netanim-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ns3/ns-allinone-3.36.1/ns-3.36.1/build/_deps/netanim-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
