...
AnimatorMode::initControls ()
{
  ...
  //connect (m_simulationTimeSlider, SIGNAL (valueChanged (int)), this, SLOT (StatsMode::updateTimelineSlot (int)));
...
AnimatorMode::updateTimelineSlot (int value)
{
  ...
  //StatsMode::getInstance()->updateTimelineSlot(value);
  ...
  if (m_playing)
    {
      ...
      //disconnect (m_simulationTimeSlider, SIGNAL (valueChanged (int)), this, SLOT (StatsMode::updateTimelineSlot (int)));
      m_simulationTimeSlider->setValue (m_currentTime);

      StatsMode::getInstance ()-> updateTimeExternal (m_currentTime);
      StatsMode::getInstance ()-> m_qLcdNumber->display (m_currentTime);
      StatsMode::getInstance ()-> updateTimelineSlot(m_currentTime);
